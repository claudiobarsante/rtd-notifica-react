...
import { Direction, Pagination } from '../logic';
    ...
    const MOCK_RESULT = [
      {
        ...
        diasEmAtraso: 516,
        endereco:
          'ETR DA CONCEICAO, nº 796, BL A CASA 5, MUTUAPIRA, SAO GONCALO/RJ CEP 24461390',
        latitude: '-22.8065778',
      ...
      },
      {
        ...
        diasEmAtraso: 516,
        endereco:
          'ETR DOS MENEZES 400 AP 1702 ALCANTARA SAO GONCALO RJ 24451230',
        latitude: '-22.8222835',
